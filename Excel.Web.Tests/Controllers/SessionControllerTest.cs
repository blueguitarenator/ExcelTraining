    ...
    public class SessionControllerTest
    {
        ...
        private List<Session> CreateSessions(DateTime saveNow, List<Athlete> athletes)
        {
            var sessions = new List<Session>() {
                new Session(){Id = 1, Hour = 6, Day = saveNow},
                new Session(){Id = 2, Hour = 7, Day = saveNow},
                new Session(){Id = 3, Hour = 8, Day = saveNow},
                new Session(){Id = 4, Hour = 9, Day = saveNow},
                new Session(){Id = 5, Hour = 10, Day = saveNow},
                new Session(){Id = 6, Hour = 16, Day = saveNow},
                new Session(){Id = 7, Hour = 17, Day = saveNow},
                new Session(){Id = 8, Hour = 18, Day = saveNow}
            };
            return sessions;
        }
